/obj/effect/overmap/ship/torch
	name = "SEV Torch"
	desc = "A bluespace-capable corvette bearing markings of SCG Expeditionary Corps."
	fore_dir = WEST
	vessel_mass = 100000
...
/obj/effect/overmap/ship/landable/exploration_shuttle
	name = "Charon"
	desc = "A medium-sized long-range shuttle. It bears markings of SCG Expeditionary Corps."
	shuttle = "Charon"
...
/obj/effect/overmap/ship/landable/aquila
	name = "Aquila"
	desc = "A vessel escort gunship. It bears markings of SCG Fleet."
	shuttle = "Aquila"
	vessel_mass = 20000
